...
def problem4(number_of_stairs, step_size, starting_point, window):
    ...
    for _ in range(number_of_stairs):
        ...
        starting_point = rg.Point(starting_point.x,starting_point.y-step_size)
        line = rg.Line(starting_point, rg.Point(starting_point.x+step_size, starting_point.y))
        line.color = 'black'
        line.thickness = 3
        line.attach_to(window)
        starting_point = rg.Point(starting_point.x+step_size, starting_point.y)
    starting_point.attach_to(window)
    window.render()
